...
func getChain() *core.BlockChain {
	...
	blocks, _ := core.GenerateChain(gspec.Config, genesis, mblash.NewFaker(), db, 2,
	...
	bc, _ := core.NewBlockChain(db, cacheConf, gspec.Config, mblash.NewFaker(), vm.Config{}, nil, nil)
