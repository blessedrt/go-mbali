...
// See https://github.com/mbali/EIPs/issues/176 for the test format specification.
...
func (t *StateTest) RunNoVerify(subtest StateSubtest, vmconfig vm.Config, snapshotter bool) (*snapshot.Tree, *state.StateDB, common.Hash, error) {
	...
	context.gomblash = vmTestBlockHash
...
func MakePreState(db mbldb.Database, accounts core.GenesisAlloc, snapshotter bool) (*snapshot.Tree, *state.StateDB) {
...
func (tx *stTransaction) toMessage(ps stPostState, baseFee *big.Int) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/mbali/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
