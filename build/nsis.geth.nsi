...
# 1. install gombl for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gombl
# 5. create gombl, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable mbali_SOCKET
...
!define GROUPNAME "mbali"
!define APPNAME "gombl"
!define DESCRIPTION "Official Go implementation of the mbali protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gombl is installed global
