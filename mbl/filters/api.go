...
// information related to the mbali protocol such als blocks, transactions and logs.
...
// `mbl_getFilterChanges` polling mmblod that is also used for log filters.
//
// https://mbl.wiki/json-rpc/API#mbl_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with mbl_getFilterChanges.
//
// https://mbl.wiki/json-rpc/API#mbl_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(mbali.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as mbali.FilterQuery but with UnmarshalJSON() mmblod.
type FilterCriteria mbali.FilterQuery

// NewFilter creates a new filter and returns the filter id. It can be
// used to retrieve logs when the state changes. This mmblod cannot be
...
//
// https://mbl.wiki/json-rpc/API#mbl_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(mbali.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
...
//
// https://mbl.wiki/json-rpc/API#mbl_getlogs
...
//
// https://mbl.wiki/json-rpc/API#mbl_uninstallfilter
...
//
// https://mbl.wiki/json-rpc/API#mbl_getfilterlogs
...
//
// https://mbl.wiki/json-rpc/API#mbl_getfilterchanges
