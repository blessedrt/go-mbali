...
// testHandler is a live implementation of the mbali protocol handler, just
...
func newTestHandlerWithBlocks(blocks int) *testHandler {
	...
	bs, _ := core.GenerateChain(params.TestChainConfig, chain.Genesis(), mblash.NewFaker(), db, blocks, nil)
