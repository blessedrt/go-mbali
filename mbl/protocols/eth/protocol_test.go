...
// Testmbl66EmptyMessages tests encoding of empty mbl66 messages
func Testmbl66EmptyMessages(t *testing.T) {
...
// Testmbl66Messages tests the encoding of all redefined mbl66 messages
func Testmbl66Messages(t *testing.T) {
