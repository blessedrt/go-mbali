...
// testBackend is a mock implementation of the live mbali message handler. Its
// purpose is to allow testing the request/reply workflows and wire serialization
// in the `mbl` protocol without actually doing any data processing.
...
func newTestBackendWithGenerator(blocks int, generator func(int, *core.BlockGen)) *testBackend {
	...
	chain, _ := core.NewBlockChain(db, nil, params.TestChainConfig, mblash.NewFaker(), vm.Config{}, nil, nil)

	bs, _ := core.GenerateChain(params.TestChainConfig, chain.Genesis(), mblash.NewFaker(), db, blocks, generator)
...
func TestGetBlockHeaders66(t *testing.T) { testGetBlockHeaders(t, mbl66) }
...
func TestGetBlockBodies66(t *testing.T) { testGetBlockBodies(t, mbl66) }
...
func TestGetNodeData66(t *testing.T) { testGetNodeData(t, mbl66) }
...
func testGetNodeData(t *testing.T, protocol uint) {
	...
	// Sanity check whmbler all state matches.
...
func TestGetBlockReceipts66(t *testing.T) { testGetBlockReceipts(t, mbl66) }
