...
// ProtocolName is the official short name of the `mbl` protocol used during
// devp2p capability negotiation.
const ProtocolName = "mbl"

// ProtocolVersions are the supported versions of the `mbl` protocol (first
// is primary).
var ProtocolVersions = []uint{mbl66}

// protocolLengths are the number of implemented message corresponding to
// different protocol versions.
var protocolLengths = map[uint]uint64{mbl66: 17}
...
// Packet represents a p2p message in the `mbl` protocol.
type Packet interface {
	Name() string // Name returns a string corresponding to the message type.
	Kind() byte   // Kind returns the message type.
}

// StatusPacket is the network packet for the status message for mbl/64 and later.
...
// GetBlockHeadersPacket66 represents a block header query over mbl/66
...
// BlockHeadersPacket66 represents a block header response over mbl/66.
...
// BlockHeadersRLPPacket66 represents a block header response over mbl/66.
...
// GetBlockBodiesPacket66 represents a block body query over mbl/66.
...
// BlockBodiesPacket66 is the network packet for block content distribution over mbl/66.
...
// BlockBodiesRLPPacket66 is the BlockBodiesRLPPacket over mbl/66
...
// GetNodeDataPacket66 represents a trie node data query over mbl/66.
...
// NodeDataPacket66 is the network packet for trie node data distribution over mbl/66.
...
// GetReceiptsPacket66 represents a block receipts query over mbl/66.
...
// ReceiptsPacket66 is the network packet for block receipts distribution over mbl/66.
...
// ReceiptsRLPPacket66 is the mbl-66 version of ReceiptsRLPPacket
...
// PooledTransactionsPacket66 is the network packet for transaction distribution over mbl/66.
...
// PooledTransactionsRLPPacket66 is the mbl/66 form of PooledTransactionsRLPPacket
