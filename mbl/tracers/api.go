...
type Backend interface {
	...
	// so this mmblod should be called with the parent.
...
// NewAPI creates a new API definition for the tracing mmblods of the mbali service.
...
type TraceCallConfig struct {
	*logger.Config
	...
	BlockOverrides *mblapi.BlockOverrides
}
...
// containsTx reports whmbler the transaction with a certain hash
...
// TraceCall lets you trace a given mbl_call. It collects the structured logs
// created during the execution of EVM if the given transaction was added on
// top of the provided block and returns them as a JSON object.
func (api *API) TraceCall(ctx context.Context, args mblapi.TransactionArgs, blockNrOrHash rpc.BlockNumberOrHash, config *TraceCallConfig) (interface{}, error) {
