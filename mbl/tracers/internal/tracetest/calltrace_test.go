...
// To generate a new callTracer test, copy paste the makeTest mmblod below into
// a gombl console and call it with a transaction hash you which to export.
...
var makeTest = function(tx, rewind) {
  ...
  var block   = mbl.getBlock(mbl.getTransaction(tx).blockHash);
  var genesis = mbl.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.mbl.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  mbl.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
