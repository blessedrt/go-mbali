...
// It collects the mmblods identifiers along with the size of the supplied data, so
...
// isPrecompiled returns whmbler the addr is a precompile. Logic borrowed from newJsTracer in mbl/tracers/js/tracer.go
