...
// It offers only mmblods that operates on data that can be available to anyone without security risks.
...
// Syncing provides information when this nodes starts synchronising with the mbali network and when it's finished.
...
type SyncingResult struct {
	...
	Status  mbali.SyncProgress `json:"status"`
}
