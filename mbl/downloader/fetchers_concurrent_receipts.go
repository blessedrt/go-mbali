...
func (q *receiptQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *mbl.Response) (*mbl.Request, error) {
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *mbl.Response) (int, error) {
	receipts := *packet.Res.(*mbl.ReceiptsPacket)
