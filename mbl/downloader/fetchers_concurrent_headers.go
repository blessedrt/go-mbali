...
func (q *headerQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *mbl.Response) (*mbl.Request, error) {
...
func (q *headerQueue) deliver(peer *peerConnection, packet *mbl.Response) (int, error) {
	headers := *packet.Res.(*mbl.BlockHeadersPacket)
