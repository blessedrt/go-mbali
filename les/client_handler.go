...
func newClientHandler(ulcServers []string, ulcFraction int, checkpoint *params.TrustedCheckpoint, backend *Lightmbali) *clientHandler {
...
func (h *clientHandler) handle(p *serverPeer, noInitAnnounce bool) error {
	...
	if err := h.backend.peers.register(p); err != nil {
		p.Log().Error("Light mbali peer registration failed", "err", err)
		return err
	}
