...
type accessTestFn func(db mbldb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db mbldb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db mbldb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db mbldb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db mbldb.Database, bhash common.Hash, num uint64) light.OdrRequest {
