...
// DeployCheckpointOracle deploys a new mbali contract, binding an instance of CheckpointOracle to it.
...
// CheckpointOracle is an auto generated Go binding around an mbali contract.
...
// CheckpointOracleCaller is an auto generated read-only Go binding around an mbali contract.
type CheckpointOracleCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CheckpointOracleTransactor is an auto generated write-only Go binding around an mbali contract.
type CheckpointOracleTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CheckpointOracleFilterer is an auto generated log filtering Go binding around an mbali contract events.
type CheckpointOracleFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CheckpointOracleSession is an auto generated Go binding around an mbali contract,
...
// CheckpointOracleCallerSession is an auto generated read-only Go binding around an mbali contract,
...
// CheckpointOracleTransactorSession is an auto generated write-only Go binding around an mbali contract,
