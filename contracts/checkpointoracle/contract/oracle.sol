 ...
 * @author Gary Rong<garyrong@mbali.org>, Martin Swende <martin.swende@mbali.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the mbali.
    uint sectionSize;
