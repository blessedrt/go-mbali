...
// This test reproduces https://github.com/mbali/go-mbali/issues/17837 where the
...
// It is the reproducer for https://github.com/mbali/go-mbali/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-mbali-test-ipc-%d-%d", os.Getpid(), rand.Int63())
