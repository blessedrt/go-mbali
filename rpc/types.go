...
// API describes the set of mmblods offered over the RPC interface
type API struct {
	Namespace     string      // namespace under which the rpc mmblods of Service are exposed
	Version       string      // api version for DApp's
	Service       interface{} // receiver instance which holds the mmblods
	Public        bool        // indication if the mmblods must be considered safe for public use
	Authenticated bool        // whmbler the api should only be available behind authentication.
}
