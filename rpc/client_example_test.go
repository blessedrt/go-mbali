...
// known to the server. The server supports two mmblods:
//
// mbl_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// mbl_subscribe("newHeads")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.mblSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	err = client.CallContext(ctx, &lastBlock, "mbl_getBlockByNumber", "latest", false)
	if err != nil {
