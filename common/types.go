...
// Address represents the 20 byte address of an mbali account.
...
// IsHexAddress verifies whmbler a string can represent a valid hex-encoded
// mbali address or not.
