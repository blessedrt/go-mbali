...
// Status implements accounts.Wallet, returning whmbler the account held by the
...
func (w *keystoreWallet) SelfDerive(bases []accounts.DerivationPath, chain mbali.ChainStateReader) {
}
