...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/mbali/pymblsaletool

		pymblsaletool generates the encryption key from password by
	...
	*/
	...
	mblPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(mblPriv)
	...
	expectedAddr := preSaleKeyStruct.mblAddr
