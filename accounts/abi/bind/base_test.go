...
func (mt *mockTransactor) EstimateGas(ctx context.Context, call mbali.CallMsg) (gas uint64, err error) {
	return 0, nil
}
...
func (mc *mockCaller) CallContract(ctx context.Context, call mbali.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockPendingCaller) PendingCallContract(ctx context.Context, call mbali.CallMsg) ([]byte, error) {
