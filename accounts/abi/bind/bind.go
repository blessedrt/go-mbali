...
// Package bind generates mbali contract Go bindings.
//
// Detailed usage document and tutorial available on the go-mbali Wiki page:
// https://github.com/mbali/go-mbali/wiki/Native-DApps:-Go-bindings-to-mbali-contracts
package bind
...
func bindStructTypeGo(kind abi.Type, structs map[string]*tmplStruct) string {
	...
	case abi.TupleTy:
		...
		// togombler here. The reason is before solidity v0.5.11, kind.TupleRawName
		// is empty, so we use canonical parameter expression to distinguish
		// different struct definition. From the consideration of backward
		// compatibility, we concat these two togombler so that if kind.TupleRawName
