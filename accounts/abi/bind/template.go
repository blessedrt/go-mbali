...
import "github.com/mbali/go-mbali/accounts/abi"
...
import (
	...
	mbali "github.com/mbali/go-mbali"
...
{{range $contract := .Contracts}}
	...
	{{if .InputBin}}
		...
		// Deploy{{.Type}} deploys a new mbali contract, binding an instance of {{.Type}} to it.
	...
	// {{.Type}} is an auto generated Go binding around an mbali contract.
	type {{.Type}} struct {
	...
	// {{.Type}}Caller is an auto generated read-only Go binding around an mbali contract.
	type {{.Type}}Caller struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Transactor is an auto generated write-only Go binding around an mbali contract.
	type {{.Type}}Transactor struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Filterer is an auto generated log filtering Go binding around an mbali contract events.
	type {{.Type}}Filterer struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Session is an auto generated Go binding around an mbali contract,
	...
	// {{.Type}}CallerSession is an auto generated read-only Go binding around an mbali contract,
	...
	// {{.Type}}TransactorSession is an auto generated write-only Go binding around an mbali contract,
...
{{if not .Library}}public {{end}}class {{.Type}} {
	...
	// mbali address where this contract is located at.
	public final Address Address;

	// mbali transaction in which this contract was deployed (if known!).
