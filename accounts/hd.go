...
// the `coin_type` 60' (or 0x8000003C) to mbali.
//
// The root path for mbali is m/44'/60'/0'/0 according to the specification
// from https://github.com/mbali/EIPs/issues/84, albeit it's not set in stone
// yet whmbler accounts should increment the last component or the children of
