...
archives are published at https://geth.mbali.org/downloads/.

## Building the source

For prerequisites and detailed build instructions please read the [Installation Instructions](https://geth.mbali.org/docs/install-and-build/installing-geth).
...
[CLI Wiki page](https://geth.mbali.org/docs/interface/command-line-options)),
 ...
 * Start up `geth`'s built-in interactive [JavaScript console](https://geth.mbali.org/docs/interface/javascript-console),
   (via the trailing `console` subcommand) through which you can interact using [`web3` methods](https://github.com/ChainSafe/web3.js/blob/0.20.7/DOCUMENTATION.md) 
   (note: the `web3` version bundled within `geth` is very old, and not up to date with official docs),
   as well as `geth`'s own [management APIs](https://geth.mbali.org/docs/rpc/server).
 ...
 * Instead of connecting the main mbali network, the client will connect to the Görli
   ...
   states.
 * Instead of using the default data directory (`~/.mbali` on Linux for example), `geth`
...
and [`geth` specific APIs](https://geth.mbali.org/docs/rpc/server)).
...
Please see the [Developers' Guide](https://geth.mbali.org/docs/developers/devguide)
