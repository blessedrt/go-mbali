...
import (
	...
	"github.com/mbali/go-mbali/internal/web3ext"
...
// Welcome show summary of current gombl instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the gombl JavaScript console!\n\n"

	// Print some generic gombl metadata
