...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gombl.ipc", false, filepath.Join(os.TempDir(), "gombl.ipc")},
		{"data", "gombl.ipc", false, "data/gombl.ipc"},
		{"data", "./gombl.ipc", false, "./gombl.ipc"},
		{"data", "/gombl.ipc", false, "/gombl.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gombl.ipc", true, `\\.\pipe\gombl.ipc`},
		{"data", "gombl.ipc", true, `\\.\pipe\gombl.ipc`},
		{"data", `\\.\pipe\gombl.ipc`, true, `\\.\pipe\gombl.ipc`},
	}
