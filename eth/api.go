...
func (api *PublicmbaliAPI) Etherbase() (common.Address, error) {
...
// admin methods of the mbali service.
func NewPrivateAdminAPI(eth *mbali) *PrivateAdminAPI {
...
// related public debug methods of the mbali service.
func NewPublicDebugAPI(eth *mbali) *PublicDebugAPI {
...
// private debug methods of the mbali service.
func NewPrivateDebugAPI(eth *mbali) *PrivateDebugAPI {
