...
state generators can swap between a `gombl`-based implementation and a `parityvm`-based
implementation.
...
- `state.reward`
  - For mblash, it is `5000000000000000000` `wei`,
...
ERROR(4): gomblash(3) invoked, blockhash for that block not provided
```
Error code: 4
