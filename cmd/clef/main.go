...
import (
	...
	"github.com/mbali/go-mbali/signer/fourbyte"
	"github.com/mbali/go-mbali/signer/rules"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage mbali account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func checkFile(filename string) error {
	...
	// https://github.com/mbali/go-mbali/issues/20123
