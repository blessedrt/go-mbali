...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage mbali presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gombl wallet import /path/to/my/presale.wallet

will prompt for your password and imports your mbler presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import mbali presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gombl wallet [options] /path/to/my/presale.wallet
...
between mbali nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gombl account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gombl account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another mbali instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gomblConfig{Node: defaultNodeConfig()}
	// Load config file.
