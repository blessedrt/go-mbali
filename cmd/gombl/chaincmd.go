...
It's deprecated, please use "gombl db import" instead.
`,
	}
...
It's deprecated, please use "gombl db export" instead.
`,
	}
...
func parseDumpConfig(ctx *cli.Context, stack *node.Node) (*state.DumpConfig, mbldb.Database, common.Hash, error) {
	db := utils.MakeChainDatabase(ctx, stack, true)
