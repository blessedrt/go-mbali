...
const (
	ipcAPIs  = "admin:1.0 debug:1.0 engine:1.0 mbl:1.0 mblash:1.0 miner:1.0 net:1.0 personal:1.0 rpc:1.0 txpool:1.0 web3:1.0"
	httpAPIs = "mbl:1.0 net:1.0 rpc:1.0 web3:1.0"
)
...
func TestConsoleWelcome(t *testing.T) {
	...
	gombl := runMinimalgombl(t, "--miner.mblerbase", coinbase, "console")
...
func TestAttachWelcome(t *testing.T) {
	...
	gombl := runMinimalgombl(t, "--miner.mblerbase", "0x8605cdbbdb6d264aa742e77020dcbc58fcdce182",
		"--ipcpath", ipc,
...
func testAttachWelcome(t *testing.T, gombl *testgombl, endpoint, apis string) {
	...
	attach.SetTemplateFunc("mblerbase", func() string { return gombl.mblerbase })
