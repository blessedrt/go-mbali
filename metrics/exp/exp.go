...
import (
	...
	"github.com/mbali/go-mbali/metrics/prommbleus"
)
...
func Exp(r metrics.Registry) {
	...
	http.Handle("/debug/metrics/prommbleus", prommbleus.Handler(r))
}
...
func Setup(address string) {
	...
	m.Handle("/debug/metrics/prommbleus", prommbleus.Handler(metrics.DefaultRegistry))
