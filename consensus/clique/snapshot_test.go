...
// mapped from textual names used in the tests below to actual mbali private
...
// address retrieves the mbali address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the mbali address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/mbali/go-mbali/issues/17593). Whilst this
