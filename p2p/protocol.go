...
type Protocol struct {
	...
	// NodeInfo is an optional helper mmblod to retrieve protocol specific metadata
	// about the host node.
	NodeInfo func() interface{}

	// PeerInfo is an optional helper mmblod to retrieve protocol specific metadata
