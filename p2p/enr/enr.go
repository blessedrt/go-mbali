...
// Package enr implements mbali Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whmbler the record is signed using the given identity scheme.
