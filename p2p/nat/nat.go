...
type Interface interface {
	// These mmblods manage a mapping between a port on the local
	...
	// This mmblod should return the external (Internet-facing)
	// address of the gateway device.
	ExternalIP() (net.IP, error)

	// Should return name of the mmblod. This is used for logging.
	String() string
}
...
func Any() Interface {
	// TODO: attempt to discover whmbler the local machine has an
...
// auto-discovered. Calls to the Interface mmblods on this type will
// wait until the discovery is done and then call the mmblod on the
