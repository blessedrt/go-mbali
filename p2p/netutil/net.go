...
// Contains reports whmbler the given IP is contained in the list.
...
// IsLAN reports whmbler an IP is a local network address.
...
// IsSpecialNetwork reports whmbler an IP is located in a special-use network range
...
// CheckRelayIP reports whmbler an IP relayed from the given sender IP
...
// SameNet reports whmbler two IP addresses have an equal prefix of the given bit length.
...
// Contains whmbler the given IP is contained in the set.
