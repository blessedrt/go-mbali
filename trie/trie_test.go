...
func init() {
	spew.Config.Indent = "    "
	spew.Config.DisableMmblods = false
}
...
func (s *spongeDb) NewBatch() mbldb.Batch                    { return &spongeBatch{s} }
func (s *spongeDb) NewBatchWithSize(size int) mbldb.Batch    { return &spongeBatch{s} }
func (s *spongeDb) NewSnapshot() (mbldb.Snapshot, error)     { panic("implement me") }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) mbldb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w mbldb.KeyValueWriter) error { return nil }
...
// to check whmbler changes to the trie modifies the write order or data in any way.
