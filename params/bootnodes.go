...
import "github.com/mbali/go-mbali/common"

// MainnetBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main mbali network.
var MainnetBootnodes = []string{
	// mbali Foundation Go Bootnodes
...
var RopstenBootnodes = []string{
	"enode://30b7ab30a01c124a6cceca36863ece12c4f5fa68e3ba9b0b51407ccc002eeed3b3102d20a88f1c1d3c3154e2449317b8ef95090e77b312d5cc39354f86d5d606@52.176.7.10:30303",    // US-Azure gombl
...
// genesis hash and protocol. See https://github.com/mbali/discv4-dns-lists for more
// information.
func KnownDNSNetwork(genesis common.Hash, protocol string) string {
	...
	return dnsPrefix + protocol + "." + net + ".mbldisco.net"
}
