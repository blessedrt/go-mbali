...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllmblashProtocolChanges, new: AllmblashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllmblashProtocolChanges, new: AllmblashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllmblashProtocolChanges,
