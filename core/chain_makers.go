...
// SetDifficulty sets the difficulty field of the generated block. This mmblod is
// useful for Clique tests where the difficulty does not depend on time. For the
// mblash tests, please use OffsetTime, which implicitly recalculates the diff.
...
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db mbldb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
...
func makeHeaderChain(parent *types.Header, n int, engine consensus.Engine, db mbldb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, engine consensus.Engine, db mbldb.Database, seed int) []*types.Block {
...
func (cr *fakeChainReader) gombleaderByNumber(number uint64) *types.Header           { return nil }
func (cr *fakeChainReader) gombleaderByHash(hash common.Hash) *types.Header          { return nil }
func (cr *fakeChainReader) gombleader(hash common.Hash, number uint64) *types.Header { return nil }
