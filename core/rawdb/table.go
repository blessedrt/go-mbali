...
func NewTable(db mbldb.Database, prefix string) mbldb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(mbldb.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader mbldb.AncientReaderOp) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) mbldb.Iterator {
...
func (t *table) NewBatch() mbldb.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) mbldb.Batch {
...
func (t *table) NewSnapshot() (mbldb.Snapshot, error) {
...
func (b *tableBatch) Replay(w mbldb.KeyValueWriter) error {
