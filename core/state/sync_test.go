...
// account array.
func checkStateAccounts(t *testing.T, db mbldb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db mbldb.Database, root common.Hash) error {
...
func checkStateConsistency(db mbldb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(mbldb.Database), srcRoot)
